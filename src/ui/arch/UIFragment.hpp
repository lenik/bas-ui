...
public:
    ...
    virtual std::vector<UIElement*> loadElements() {
        return m_elements;
    }
    ...
    class ActionBuilder : public UIAction::_Builder<ActionBuilder, UIAction> {
        public:
            ...
            ActionBuilder(UIFragment* owner
                , int id
                ...
                , UIAction::_Builder<ActionBuilder, UIAction>(id
                    , dir
                    , name
                    , priority
                    , label
    ...
    class StateBuilder : public UIState::_Builder<StateBuilder, UIState> {
        public:
            ...
            StateBuilder(UIFragment* owner
                ...
                , UIState::_Builder<StateBuilder, UIState>(id
                    , dir
                    , name
                    , priority
                    , label
    ...
    class GroupBuilder : public UIGroup::_Builder<GroupBuilder, UIGroup> {
        public:
            ...
            GroupBuilder(UIFragment* owner
                ...
                , UIGroup::_Builder<GroupBuilder, UIGroup>(id
                    , dir
                    , name
                    , priority
                    , label
